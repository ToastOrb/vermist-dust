...
internal sealed partial class ChatManager : IChatManager
{
    ...
    private void SendOOC(ICommonSession player, string message)
    {
        ...
        // Prepare variables for OOC message formatting
        ...
        if (_adminManager.HasAdminFlag(player, AdminFlags.NameColor) && _preferencesManager.TryGetCachedPreferences(player.UserId, out var adminPrefs))
        {
            ...
            var adminOOCColor = "#ff0000"; // Default red for admins if pref not found
            adminOOCColor = adminPrefs.AdminOOCColor.ToHex();
            colorOverride = adminPrefs.AdminOOCColor;
    ...
    // End VDS - OOC Colors - yeah changed pretty much most of it.
